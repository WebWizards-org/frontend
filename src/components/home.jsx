      ...
      <div
        ...
        className="flex flex-col items-center justify-center mt-19 relative min-h-[600px] bg-cover bg-center bg-no-repeat md:items-start">
          ...
          <div className='w-full md:text-start text-center md:w-[35%] md:ml-20'>
            ...
            <button className='bg-gradient-to-r from-[#1B3C53] to-[#2A5470] text-white x-10 relative px-4 py-3 rounded-xl text-xl font-bold mt-10 hover:bg-blue-600 hover:shadow-xl hover:scale-105 transition-all ease-in-out duration-350'>Get Started</button>
          </div>
