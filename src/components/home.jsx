...
export default function Home() {
 ...
 const steps = [
  {
    title: "Sign Up", desc: "Create your free account and explore our course catalog", icon: <Users className="w-15 h-15 text-blue-600" />, number : 1
  },
  {
    title: "Learn", desc: "Access high-quality video lessons, assignments, and resources", icon: <Video className="w-15 h-15 text-blue-600" />, number : 2
  },
  {
    title: "Get Certified", desc: "Complete courses and earn certificates to showcase your skills", icon: <Award className="w-15 h-15 text-blue-600" />, number : 3
  }
 ]
    ...
    <>
      ...
      <div className='bg-gray-100'>
        <div
          ...
          className="flex mt-21 justify-start relative min-h-[580px] bg-cover bg-center bg-no-repeat md:items-start">
            ...
            <div className='w-140 mt-15 mx-10 '>
              ...
              <p className='text-gray-600 relative x-10 md:text-xl pb-10'>Join thousands of learner mastering new skills with our interactive learning platform. Start your journey today and unlock your potential.</p>

              <Link 
                to="/register" 
                className='bg-blue-500 text-white relative px-4 py-3 rounded-xl text-xl font-bold mt-10 hover:bg-blue-600 hover:shadow-xl hover:scale-105 transition-all ease-in-out duration-350'>Get Started</Link>
            </div>            
        </div>
        ...
        <div className=' mx-auto text-center py-20 bg-blue-50 text-white'>
          <h1 className='text-[45px] text-blue-500 font-bold'>Ready to Transform Your Future?</h1>
          <p className='text-lg text-gray-700 mb-6'>Join over 50,000 students who are already building the skills they need to succeed in tomorrow's economy</p>
        </div>
